...
<!-- Edit Modal -->
<div class="modal fade" id="editmodal-{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="editmodal-{{$user->id}}Label">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="editmodal-{{$user->id}}Label">Edit User</h4>
      </div>
